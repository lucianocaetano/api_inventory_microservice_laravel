...
class GetAProductTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_get_a_product()
    {
        ...
        $response = $this->getJson(
            "/api/v1/product/" . $this->product->slug,
            [
    ...
    public function test_get_a_product_but_i_do_not_have_permission()
    {
    ...
    public function test_get_a_product_but_i_do_not_have_token()
    {
        $response = $this->getJson(
            "/api/v1/product/" . $this->product->slug,
            [
    ...
    public function test_get_a_product_but_this_product_does_not_exists()
    {
        $response = $this->getJson(
